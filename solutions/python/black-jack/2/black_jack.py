...
def value_of_ace(card_one, card_two):
    ...
    if card_one == "A" or card_two == "A":
        total_value += 10
    value_to_hit = MAX_HIT_VALUE - total_value
    if value_to_hit >= 11:
        return 11
    return 1
...
def is_blackjack(card_one, card_two):
    ...
    return (card_one == "A" and card_two in {"J", "Q", "K" , "10"}) or (card_two == "A" and card_one in {"J", "Q", "K", "10"})
...
def can_split_pairs(card_one, card_two):
   ...
   Returns:
    ...
    return (card_one in {"J", "Q", "K", "10"} and card_two in {"J", "Q", "K", "10"}) or card_one == card_two
