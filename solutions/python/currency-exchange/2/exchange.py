...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    new_exchange_rate = exchange_rate + spread_rate
    new_currency_money = exchange_money(budget, new_exchange_rate)
    leftover_money = get_leftover_of_bills(new_currency_money, denomination)
    return new_currency_money - leftover_money
